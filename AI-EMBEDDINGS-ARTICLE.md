...
- pipeline & wire format → [`docs/LOSSY-VECTOR.md`](https://github.com/alex60217101990/qdf/blob/main/docs/LOSSY-VECTOR.md)
- decode paths (arena / zero-copy) → [`docs/ARENA.md`](https://github.com/alex60217101990/qdf/blob/main/docs/ARENA.md)
- rate-distortion / recall rows → `cmd/qdf-vecbench/rd.csv`, generated by the [`qdf-vecbench` tool](https://github.com/alex60217101990/qdf/tree/main/cmd/qdf-vecbench)
- runnable end-to-end → `Example_aiEmbeddingStore` in [`example_lossyvec_test.go`](https://github.com/alex60217101990/qdf/blob/main/example_lossyvec_test.go)
